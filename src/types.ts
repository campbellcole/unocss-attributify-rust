...
export interface AttributifyOptions extends PresetOptions {
  ...
  /**
   * EXPERIMENTAL: Force use of `rsx!` parsing instead of normal HTML/JSX/TSX parsing
   * 
   * @default false
   */
  rsxParsing?: boolean,
  ...
  /**
   * EXPERIMENTAL: Automatically detect rust code and use `rsx!` parsing only where necessary
   * 
   * @default false
   */
  detectRust?: boolean,
